    ...
    <nav class="border-b border-slate-800/80 bg-surface-900/90 sticky top-0 z-50 backdrop-blur-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2 sm:gap-4 text-xs font-mono">
                ...
                <a href="guide.html" class="px-3 py-1.5 rounded-lg bg-indigo-600/20 hover:bg-indigo-600/30 text-indigo-300 hover:text-white border border-indigo-500/30 transition-all flex items-center gap-1.5" title="Vollständiges Benutzer-Handbuch öffnen">
                    <i class="fa-solid fa-book-open text-indigo-400"></i>
                    <span class="hidden sm:inline">Handbuch</span>
                </a>
                <button onclick="window.print()" class="px-3 py-1.5 rounded-lg bg-surface-800 hover:bg-surface-700 text-slate-300 border border-slate-700 transition-all flex items-center gap-1.5">
...
html_parts.append("""
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-10">
        ...
        <!-- User Guide Quick-Access Banner -->
        <div class="glass-card p-5 rounded-2xl border border-indigo-500/30 bg-gradient-to-r from-indigo-950/40 via-surface-900 to-surface-850 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xl">
            <div class="flex items-center gap-3.5">
                <div class="w-12 h-12 rounded-xl bg-indigo-600/30 border border-indigo-500/40 flex items-center justify-center text-indigo-400 text-xl flex-shrink-0">
                    <i class="fa-solid fa-book-bookmark"></i>
                </div>
                <div>
                    <div class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 text-[10px] font-bold uppercase tracking-wider mb-1">
                        Dokumentation
                    </div>
            ...
            <a href="guide.html" class="w-full sm:w-auto px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white font-semibold text-xs shadow-lg shadow-indigo-500/25 flex items-center justify-center gap-2 whitespace-nowrap transition-all">
                <span>Handbuch im Browser öffnen</span>
